                ...
                .addOnCompleteListener(SignUpActivity.this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (!task.isSuccessful()) {
                            pd.dismiss();
                            System.out.println("AAAAAAAAAAAAAAAAAAAAA  "+task.getException());
                            System.out.println("AAAAAAAAAAAAAAAAAAAAA  "+task.getException().getMessage());
                            System.out.println("AAAAAAAAAAAAAAAAAAAAA  "+task.getException().getStackTrace());
